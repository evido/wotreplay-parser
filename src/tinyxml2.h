...
class TINYXML2_LIB XMLUtil {
  public:
    ...
    static char *SkipWhiteSpace(char *p, int *curLineNumPtr) { return const_cast<char *>(SkipWhiteSpace(const_cast<const char *>(p), curLineNumPtr)); }
...
class TINYXML2_LIB XMLNode {
  ...
  public:
    ...
    */
    ...
    XMLElement *FirstChildElement(const char *name = 0) { return const_cast<XMLElement *>(const_cast<const XMLNode *>(this)->FirstChildElement(name)); }
    ...
    */
    ...
    XMLElement *LastChildElement(const char *name = 0) { return const_cast<XMLElement *>(const_cast<const XMLNode *>(this)->LastChildElement(name)); }
    ...
    XMLElement *NextSiblingElement(const char *name = 0) { return const_cast<XMLElement *>(const_cast<const XMLNode *>(this)->NextSiblingElement(name)); }
    ...
    */
    ...
    /** Accept a hierarchical visit of the nodes in the TinyXML-2 DOM. Every
       ...
       doesn't re-parse the XML for the callbacks, so the performance of
       TinyXML-2 is unchanged by using this interface versus any other.)
  ...
  public:
    ...
    */
    ...
    /** QueryIntValue interprets the attribute as an integer, and returns the
       ...
       success, and XML_WRONG_ATTRIBUTE_TYPE if the conversion is not
       successful.
    */
...
class TINYXML2_LIB XMLElement : public XMLNode {
  ...
  public:
    ...
    */
    ...
    XMLError QueryAttribute(const char *name, unsigned int *value) const { return QueryUnsignedAttribute(name, value); }
    ...
    */
    ...
    /**
       ...
       text cannot be converted to the requested type, and XML_NO_TEXT_NODE if
       there is no child text to query.
