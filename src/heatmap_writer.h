...
/**
 * @fn std::tuple<float, float> get_bounds(boost::multi_array<float,
 * 3>::const_reference image, float l_quant,float r_quant) Determine nth_value
 * from sorted arrays for lower and upper bound
