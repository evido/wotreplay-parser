...
BOOST_FUSION_ADAPT_STRUCT(operation_t,
                          (operator_t, op)(operand_t, left)(operand_t, right))
...
template <typename Iterator>
struct draw_rules_grammar_t
    : qi::grammar<Iterator, std::vector<draw_rule_t>(), ascii::space_type> {
  draw_rules_grammar_t() : draw_rules_grammar_t::base_type(rules) {
    ...
    // define operator
    operators.add("=", operator_t::EQUAL)("!=", operator_t::NOT_EQUAL)(
        ">=", operator_t::GREATER_THAN_OR_EQUAL)(">", operator_t::GREATER_THAN)(
    ...
    // define symbols
    symbols.add("player", symbol_t::PLAYER)("clock", symbol_t::CLOCK)(
        "team", symbol_t::TEAM)("tank_tier", symbol_t::TANK_TIER)(
        "tank_class", symbol_t::TANK_CLASS)("tank_icon", symbol_t::TANK_ICON)(
        "tank_country", symbol_t::TANK_COUNTRY)("tank_name",
                                                symbol_t::TANK_NAME);
    ...
    expression = (operation[at_c<1>(_val) = _1] >>
                  logical_operators[at_c<0>(_val) = _1] >>
    ...
    operation = operand[at_c<1>(_val) = _1] > operators[at_c<0>(_val) = _1] >
...
virtual_machine_t::virtual_machine_t(const game_t &game,
...
std::string virtual_machine_t::operator()(operation_t operation) {
  ...
  case operator_t::LESS_THAN:
    result =
        boost::lexical_cast<double>(lhs) < boost::lexical_cast<double>(rhs);
    break;
