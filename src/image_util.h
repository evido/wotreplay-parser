...
/**
 * @fn void get_row_pointers(boost::multi_array<uint8_t, 3> &image,
 ...
 * &game_mode, boost::multi_array<uint8_t, 3> &base);
 ...
 * @param image The output variable, the array will be resized to contain the
