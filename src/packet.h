 ...
 */
template <typename U, typename T> const U &get_field(T begin, T end, size_t offset) {
...
class packet_t {
  public:
    ...
    /**
     * Sets internal packet data to the data passed to the method, the
     * properties of this packet are updated accordingly.
